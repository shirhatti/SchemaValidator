...
class ValidateSchema(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            self.result = False
        try:
            print(jsonschema.validate(json_data, schema))
        except jsonschema.exceptions.ValidationError as e:
            dest_view = self.view.window().new_file()
            dest_view.set_name("Schema Validation Results")
            dest_view.run_command('content_prepend', {'text': "sadfasdfsfafs"})
            print(e.message)
